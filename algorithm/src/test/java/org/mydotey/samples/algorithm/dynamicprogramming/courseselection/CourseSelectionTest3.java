...
public abstract class CourseSelectionTest3 {
    ...
    public static Collection<Object[]> data() {
        ...
        totalCourse = 2;
        selection = new HashSet<>(Arrays.asList(2, 3));
    ...
    @Test
    public void selectMostScore() {
        Assert.assertEquals(selection, _courseSelection.selectMostScore(courses, totalCourse));
    }
