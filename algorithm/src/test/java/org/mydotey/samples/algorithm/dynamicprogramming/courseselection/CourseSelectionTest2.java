...
public abstract class CourseSelectionTest2 {
    ...
    public static Collection<Object[]> data() {
        ...
        totalScore = 20;
        selection = new HashSet<>(Arrays.asList(3, 4, 5));
    ...
    @Test
    public void selectLeastCourses() {
        Assert.assertEquals(selection, _courseSelection.selectLeastCourses(courses, totalScore));
    }
